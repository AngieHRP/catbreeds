...
class BodyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(statusBarColor: Colors.transparent,  systemNavigationBarIconBrightness: Brightness.dark,
          ...
          Expanded(
            child: Stack(
              children: [
                ...
                Container(
                  height: onBack ? MediaQuery.of(context).size.width * 0.15  : MediaQuery.of(context).size.width * 0.35,
                      ...
                      Visibility(
                        ...
                        child: Container(
                          ...
                          child: IconButton(
                            icon: const Icon(
                              Icons.arrow_back,
                              color: Color.fromRGBO(80, 56, 80, 1),
                              size: 24.0,
                            ),
